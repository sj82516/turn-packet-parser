import { MessageClass, MessageMethod, StunMessage, AttributeList, Attribute, AddressAttributeName, BasicAttributeName, BasicAttribute, AddressAttribute } from "./index.types";
    ...
    private parseAttributes(rawAttributeData: string, transactionId: string): AttributeList {
        ...
        while (idx < rawAttributeData.length) {
            ...
            if (attributeName in BasicAttributeName) {
                const attribute: BasicAttribute = {
                    length,
                    value: rawData
                }

                attributeList[
                    BasicAttributeName[attributeName]
                ] = attribute;
            }
            ...
            if (attributeName in AddressAttributeName) {
                ...
                attributeList[
                    AddressAttributeName[attributeName]
                ] = attribute;
            }

...
export default function parseXorAddress(attribute: BasicAttribute, rawAttributeData, idx: number, transactionId: string, MagicCookie: string, isXor: boolean): AddressAttribute {
